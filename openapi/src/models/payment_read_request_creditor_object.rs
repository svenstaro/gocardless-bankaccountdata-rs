...
/// PaymentReadRequestCreditorObject : Creditor account



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PaymentReadRequestCreditorObject {
...
impl PaymentReadRequestCreditorObject {
    /// Creditor account
    pub fn new(name: String, account: String, currency: String) -> PaymentReadRequestCreditorObject {
